...
function SavoirFaire() {
  return (
    <div className="Savoir_Faire_Title">
      <div className="Savoir_Faire_Container">
        <div className="Savoir_Faire_Explications">
          <h1>Ecoute et Conseil</h1>
          <p>
            Notre équipe est constituée de spécialistes qui sauront vous écouter
            et conseiller. Venez nous exposer vos problèmes et nous vous
            aiderons a trouver la solution, en vous proposant une gamme de
            produits sélectionnés pour leurs qualités tout en restant dans un
            budget adapté.
          </p>
        </div>
        <div className="Partenairs_List">
          ...
          <Link to="https://www.haghebaert-fremaux.com/">
            <div className="Hagh">
              <img
                src={LogoHagh}
                alt="Logo de la marque Haghebaert et Fremaux"
              />
          ...
          <Link to="https://www.theolaur.com/">
            <div className="Theolaur">
              <img
                src={LogoTheolaur}
                alt="Logo de la marque Theodore Lefebvre"
              />
